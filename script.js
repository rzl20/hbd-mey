...
new TypeIt("#teks1", {
  strings: ["Assalamualaikum Wr. Wb", " ", "Saya Rizal Hidayatullah pada hari ini Jum'at, 20 Mei 2022 dengan sepenuh hati mengucapkan", " ", "<b>Selamat Ulang Tahun Yang ke - 21</b>", " ", "Kepada Isti Amelia Gani, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari saya", , " ", "Wassalamualakaikum Wr. Wb", " ", "- ijal, si mantan :v"],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Haii mantannnnn!!", "Happy Birthday ya..", " ", "Ciie udah 21 tahun, padahal baru aja beberapa hari kemarin umur kita sama hehe, semoga di umur yang sekarang mey bisa jadi pribadi yang lebih baik lagi, lebih rajin, lebih sholehah, dan lebih berbakti.", "Maaf ya ijal gabisa kasih surprise yang romantis. Cuma ini yang bisa ijal kasih ke mey, ijal harap mey suka ya :v", "Sekali lagi, Selamat Ulang Tahun ya. Semoga semua impian, keinginan, dan harapan mey bisa tercapai, Aamiin."],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
...
new TypeIt("#trims", {
  strings: ["Anjayyyyy, Balikan yuk :v"],
  startDelay: 2000,
  speed: 150,
  loop: false,
  waitUntilVisible: true,
